                            ...
                            <div className="relative grid grid-cols-1 gap-8 z-10">
                                <div className="space-y-6 text-center">
                                    ...
                                    <div className="flex flex-col items-center justify-center py-4 md:py-6">
                                        <div className="relative inline-block group/counter cursor-default">
                                            {/* Animated Counter */}
                                            <span className="text-6xl md:text-9xl font-black italic tracking-normal text-[#4ade80] drop-shadow-[0_0_25px_rgba(74,222,128,0.25)] transition-all duration-300 group-hover/counter:drop-shadow-[0_0_35px_rgba(74,222,128,0.4)]">
                                                +{user?.elo ? (Math.ceil(user.elo / 100) * 100) - user.elo : 100}
                                            </span>
                                            <span className="absolute -top-2 -right-10 md:-top-4 md:-right-16 text-lg md:text-2xl font-black italic text-[#4ade80] rotate-12 opacity-80 animate-pulse">pts</span>
                                        </div>
                                    </div>
