-- Migration: Add missing location columns to profiles and fix Radar RPC
-- Description: Adds lat/lng columns to profiles and redefines get_radar_matches to use them.
...
-- 2. Drop existing function first because the return type (columns) is changing
DROP FUNCTION IF EXISTS get_radar_matches(uuid, text);

-- 3. Redefine get_radar_matches
